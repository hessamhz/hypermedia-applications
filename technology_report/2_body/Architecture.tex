...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \texttt{color} specifies the color text and other elements of the header. It should just contain the name of the color, which is going to be attached to the Tailwind CSS \textt{text-} and \texttt{border-} prefixes in the class field.
        \end{itemize}
