...
useSeoMeta({
  ...
  description:
    'Learn more about the history of The Hive, Anti-Violence Center for Women.',
    ...
    >
      <div>
        ...
        <p class="xl:text-lg">
          ...
          vision of creating a safe haven for women affected by violence.
          Combining their diverse backgrounds in social work, psychology, and
          legal advocacy, they established the center to offer comprehensive
          support and resources. Their collective passion and commitment have
          transformed The Hive into a beacon of hope, empowering countless women
          to reclaim their lives and find healing and strength within a
      ...
      <img
        ...
        alt=""
        class="rounded-xl drop-shadow-md sm:mx-auto sm:max-w-96 lg:max-w-md xl:max-w-lg xl:rounded-2xl 2xl:max-w-xl"
      />
    </div>
    <div class="flex flex-col bg-hive-beige py-12 text-center">
      <h2
        class="pb-6 text-2xl font-bold text-hive-purple lg:mb-10 lg:text-3xl xl:text-4xl"
      >
        What we value
      </h2>
      <div class="gap-10 px-6 md:grid md:grid-cols-3 md:gap-x-32 md:px-32">
        <div class="mb-6 flex flex-col items-center gap-2">
          <svg
            class="mb-4 w-20 fill-gray-900"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
            <title>account-tie-woman</title>
            <path
          ...
          <h6 class="text-xl font-semibold">Empowerment</h6>
          <p class="text-gray-700">
            We believe in equipping women with the knowledge, resources, and
            confidence they need to take control of their lives and futures.
          </p>
        </div>
        <div class="flex flex-col items-center gap-2">
          ...
          <p class="text-gray-700">
            Our approach is rooted in empathy and understanding, ensuring that
            every woman feels heard, respected, and supported.
          </p>
        </div>
        <div class="flex flex-col items-center gap-2">
          <svg
          ...
          <p class="text-gray-700">
            We foster a sense of belonging and solidarity, creating a network of
            support where women can connect, share experiences, and find
            strength in unity
          </p>
        </div>
      </div>
    ...
    <div>
      ...
      >
        ...
        <div class="">
          ...
          <p class="xl:text-lg">
            The Hive strives to provide a safe, supportive, and empowering
            environment for women who have experienced mistreatment and
            violence. We are dedicated to offering comprehensive resources,
            including emotional support, legal assistance, and educational
            programs, to help women rebuild their lives. Our goal is to foster a
            community where every woman can find strength, healing, and the
